  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#0d1117]/90 backdrop-blur-2xl border-b border-white/[0.07] shadow-2xl shadow-black/20'
          : 'bg-transparent'
      }`}
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden bg-[#0d1117]/95 backdrop-blur-2xl border-b border-white/[0.07] overflow-hidden"
          >
