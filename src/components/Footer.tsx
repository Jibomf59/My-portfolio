        ...
        >
          {socials.map((s) => (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="p-3 rounded-xl bg-white/[0.04] border border-white/8 text-slate-500 hover:text-pink-400 hover:border-pink-400/25 hover:bg-pink-400/5 transition-all"
              aria-label={s.label}
            >
              <s.icon size={17} />
            </motion.a>
