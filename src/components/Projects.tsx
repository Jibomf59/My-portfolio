      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col flex-1 p-6">
                  ...
                  <div className={`grid gap-2 ${project.demo ? 'grid-cols-2' : 'grid-cols-1'}`}>
                    <motion.a
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#24292e] border border-white/15 text-white hover:bg-[#2f363d] hover:border-white/25 text-sm font-semibold transition-all"
                    >
                      <FaGithub size={14} />
                      GitHub
                    </motion.a>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.96 }}
            className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-[#24292e] border border-white/15 text-white font-semibold text-sm hover:bg-[#2f363d] hover:border-white/25 transition-colors"
          >
            <FaGithub size={17} />
            View all on GitHub
